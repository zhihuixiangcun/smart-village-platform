<template>
  <div class="profile-search-form">
    <el-form ref="formRef" :model="formData" label-width="100px">
      ...
      <div class="search-section">
        <h4>特殊群体</h4>
        <el-form-item label="标签筛选" prop="tags">
      ...
      <div class="search-section">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="家庭成员数" prop="familySize">
              <el-input-number
                v-model="formData.familySizeMin"
                :min="0"
                placeholder="最少人数"
                style="width: 45%"
              />
              <span style="margin: 0 5px">-</span>
              <el-input-number
                v-model="formData.familySizeMax"
                :min="0"
                placeholder="最多人数"
                style="width: 45%"
              />
      ...
      <el-collapse v-model="activeCollapse">
        <el-collapse-item title="更多搜索条件" name="more">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="创建时间" prop="createdAt">
                <el-date-picker
                  v-model="formData.createdAtRange"
                  type="daterange"
                  range-separator="至"
            ...
            <el-col :span="8">
              <el-form-item label="更新时间" prop="updatedAt">
                <el-date-picker
                  v-model="formData.updatedAtRange"
                  type="daterange"
                  range-separator="至"
                  start-placeholder="开始日期"
                  end-placeholder="结束日期"
