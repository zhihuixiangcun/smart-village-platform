  ...
  >
    ...
    >
      ...
      <el-form-item label="具体作物" v-if="postForm.cropCategory">
        <el-input v-model="postForm.cropName" placeholder="如：水稻、小麦、番茄等" clearable />
      </el-form-item>
      ...
      <el-form-item label="内容性质">
        <el-checkbox v-model="postForm.isQuestion"> 这是一个求助问题 </el-checkbox>
      </el-form-item>
        ...
        <div class="media-upload-section">
          ...
          <div class="upload-section">
            ...
            >
              ...
              <div slot="tip" class="el-upload__tip">只能上传mp4文件，且不超过50MB，最多3个</div>
            </el-upload>
          </div>
        </div>
      </el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="submitPost" :loading="submitting"> 发布分享 </el-button>
    </div>
  </el-dialog>
</template>
...
export default {
  ...
  methods: {
    ...
    updateSuggestedTags() {
      ...
      this.suggestedTags = Array.from(suggestions)
        .filter(tag => !this.postForm.tags.includes(tag))
        .slice(0, 6);
    },
