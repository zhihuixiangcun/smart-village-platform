<template>
  <div class="map-view">
    ...
    <div class="map-toolbar">
      ...
      <el-button-group>
        <el-button icon="el-icon-plus" size="small" @click="zoomIn"> 放大 </el-button>
        <el-button icon="el-icon-minus" size="small" @click="zoomOut"> 缩小 </el-button>
        <el-button icon="el-icon-aim" size="small" @click="resetView"> 重置 </el-button>
      </el-button-group>

      <el-divider direction="vertical" />

      <el-switch v-model="showVillages" active-text="显示村庄" @change="toggleVillages" />
      <el-switch v-model="showFacilities" active-text="显示设施" @change="toggleFacilities" />
      <el-switch v-model="showResidents" active-text="显示村民" @change="toggleResidents" />
    </div>
    ...
    <!-- 侧边栏信息面板 -->
    <el-drawer v-model="infoDrawerVisible" direction="rtl" size="400px" title="地图信息">
      <div class="map-info-content">
        ...
        <el-card v-if="weatherInfo" class="mb-4" header="天气信息">
          <div class="weather-info">
            ...
            <div class="weather-details">
              ...
              <p>
                风向：{{ weatherInfo.weather?.winddirection }}
                {{ weatherInfo.weather?.windpower }}级
              </p>
        ...
        <el-card v-if="facilitiesStats" class="mb-4" header="周边设施">
          <div class="facilities-stats">
            <div v-for="(count, type) in facilitiesStats" :key="type" class="facility-type">
    ...
    <!-- 路线规划对话框 -->
    <el-dialog v-model="routeDialogVisible" title="路线规划" width="600px">
    ...
    <div class="map-actions">
      <el-button type="primary" icon="el-icon-menu" circle @click="infoDrawerVisible = true" />
      <el-button type="success" icon="el-icon-guide" circle @click="routeDialogVisible = true" />
      <el-button type="warning" icon="el-icon-location" circle @click="getCurrentLocation" />
    </div>
  </div>
</template>
