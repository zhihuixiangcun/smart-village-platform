          ...
          <div v-if="role === 'resident'">
            ...
            >
              ...
              <el-form-item label="户主姓名" prop="householderName">
                <el-input
                  v-model="formData.residentInfo.householderName"
                  placeholder="请输入户主姓名"
                />
              </el-form-item>
  ...
  switch (currentStep.value) {
    ...
    case 3:
      if (role.value === 'resident') {
        ...
        return (
          formData.officialInfo.township &&
          formData.officialInfo.department &&
          formData.files.workCard
        );
...
const submitRegistration = async () => {
  ...
  try {
    ...
    if (role.value === 'resident') {
      ...
      submitData.cadreInfo = {
        ...formData.cadreInfo,
        appointmentProof: formData.files.appointmentProof,
      };
    } else if (role.value === 'official') {
      submitData.officialInfo = { ...formData.officialInfo, workCard: formData.files.workCard };
    } else if (role.value === 'admin') {
      submitData.adminInfo = {
        ...formData.adminInfo,
        authorizationFile: formData.files.authorizationFile,
      };
    }
