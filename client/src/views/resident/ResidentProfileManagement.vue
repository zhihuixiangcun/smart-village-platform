      ...
      >
        ...
        <el-table-column label="照片" width="80" align="center">
          <template #default="{ row }">
            <el-avatar
              :size="50"
              :src="row.personalInfo.photo"
              :alt="row.personalInfo.name"
            >
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" @click="viewProfile(row)">
              查看
            </el-button>
...
import {
  User, Male, Female, CreditCard, Plus, Search, Download, ArrowDown
...
const isSpecialGroup = (profile) => {
  const specialTags = ['党员', '村干部', '退役军人', '残疾人', '低保户', '五保户',
                        '留守儿童', '空巢老人', '独居老人', '大病家庭', '单亲家庭',
                        '失独家庭', '烈属', '优抚对象', '困难党员']
