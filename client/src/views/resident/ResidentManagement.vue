<template>
  <div class="resident-management">
    ...
    <!-- 村民详情对话框 -->
    <el-dialog v-model="detailVisible" title="村民详情" width="900px" destroy-on-close>
      <ResidentDetail
        v-if="detailVisible"
    ...
    <!-- 家庭信息对话框 -->
    <el-dialog v-model="familyVisible" title="家庭信息" width="1000px" destroy-on-close>
      <FamilyInfo v-if="familyVisible" :resident="currentResident" @close="familyVisible = false" />
    </el-dialog>
  </div>
</template>
