      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            ...
            <el-button size="small" icon="Sort" @click="showSortDialog = true">
              排序
            </el-button>
          </div>
        </div>
            ...
            <div class="expand-content">
              <el-row :gutter="20">
                <el-col :span="12">
                  ...
                  <p><strong>发证机关：</strong>{{ row.documentInfo.issuingAuthority || '未填写' }}</p>
                ...
                <el-col :span="12">
                  ...
                  <div v-if="row.ocrResult && row.ocrResult.text">
                    ...
                    <p><strong>置信度：</strong>{{ (row.ocrResult.confidence * 100).toFixed(1) }}%</p>
                  </div>
            ...
            <el-card class="document-card" shadow="hover" @click="previewDocument(document)">
              ...
              <div class="document-info">
                ...
                <p class="document-meta">
                  ...
                  <el-tag
                    :type="getStatusTagType(document.documentInfo.status)"
                    size="small"
                  >
...
import {
  Document, Files, Picture, Clock, Share, Upload, Search, Download,
  Sort, Check, Loading, ArrowDown
...
const handleShareSubmit = async (shareData) => {
  try {
    await documentApi.shareDocument(shareDocument.value._id, shareData.sharedWith, shareData.permission)
