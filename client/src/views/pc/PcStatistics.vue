    ...
    series: [
      {
        ...
        label: { show: false },
        data: [
          { value: 285, name: '核心家庭', itemStyle: { color: '#667eea' } },
          { value: 95, name: '三代同堂', itemStyle: { color: '#4facfe' } },
          { value: 45, name: '空巢家庭', itemStyle: { color: '#43e97b' } },
          { value: 31, name: '单身家庭', itemStyle: { color: '#fa709a' } },
        ],
      },
    ],
  };
    ...
    series: [
      {
        ...
        label: { show: false },
        data: [
          { value: 85, name: '1人户', itemStyle: { color: '#667eea' } },
          { value: 165, name: '2人户', itemStyle: { color: '#4facfe' } },
          { value: 128, name: '3人户', itemStyle: { color: '#43e97b' } },
          { value: 78, name: '4人户', itemStyle: { color: '#fa709a' } },
        ],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [
          { value: 285, name: '劳动力', itemStyle: { color: '#667eea' } },
          { value: 156, name: '学生', itemStyle: { color: '#4facfe' } },
          { value: 198, name: '老人', itemStyle: { color: '#43e97b' } },
          { value: 89, name: '特殊群体', itemStyle: { color: '#fa709a' } },
          { value: 528, name: '其他', itemStyle: { color: '#a18cd1' } },
        ],
      },
    ],
  };
