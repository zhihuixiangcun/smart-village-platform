  ...
  >
    <div v-if="member" class="member-detail">
          ...
          <div class="info-section">
            <el-descriptions :column="2" border>
              ...
              <el-descriptions-item label="健康状态">
                <el-tag :type="getHealthStatusType(member.healthStatus)" size="small">
      ...
      <el-card class="history-card" shadow="never">
        ...
        <div v-if="!operationHistory.length" class="no-data">暂无操作记录</div>
      </el-card>
    </div>
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="editMember" icon="Edit" v-permission="['resident:write']">
          编辑信息
        </el-button>
      </div>
    </template>
