...
<template>
  <div class="feedback-submission">
    <el-card class="submission-card">
      ...
      >
        ...
        <el-form-item label="相关页面">
          <el-input v-model="form.context?.page" placeholder="请输入相关页面路径（可选）">
            <template #prepend>
        ...
        <el-form-item>
          <div class="form-actions">
            ...
            <el-button type="primary" size="large" :loading="submitting" @click="submitFeedback">
              提交反馈
            </el-button>
          </div>
        </el-form-item>
    ...
    <!-- 反馈条款对话框 -->
    <el-dialog v-model="showTerms" title="反馈条款" width="600px">
      <div class="terms-content">
        ...
        <h4>2. 隐私保护</h4>
        <p>
          我们承诺对您的个人信息进行严格保密，仅用于处理反馈和改进服务。请避免在反馈中包含敏感个人信息。
        </p>

        <h4>3. 处理时效</h4>
        <p>
          我们将在收到反馈后尽快处理，一般问题将在3-5个工作日内回复您，复杂问题可能需要更长时间。
        </p>
...
const commonTags = ['界面问题', '功能问题', '性能问题', '兼容性', '易用性', '文档建议', '其他'];
...
const submitFeedback = async () => {
  try {
    ...
    // 确认提交
    await ElMessageBox.confirm('确定要提交反馈吗？提交后我们将尽快处理。', '确认提交', {
