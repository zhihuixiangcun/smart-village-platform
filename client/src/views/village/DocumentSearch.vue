<template>
  <div class="document-search">
    <!-- 顶部导航 -->
    <van-nav-bar title="资料搜索" left-arrow @click-left="$router.go(-1)" />
        ...
        >
          ...
          <template #right-icon>
            <div class="result-meta">
              ...
              <div class="relevance-score">匹配度: {{ Math.round(document.relevance * 100) }}%</div>
            </div>
          </template>
        </van-cell>
      </van-cell-group>
...
// 热门搜索
const hotSearches = ref(['财务报表', '会议记录', '村民档案', '项目申报', '政策文件', '应急预案']);
