    ...
    <el-tabs v-model="activeTab">
      ...
      <el-tab-pane label="手机号搜索" name="phone">
        <el-form :model="phoneForm" label-width="80px">
          ...
          <el-form-item>
            <el-button type="primary" @click="searchByPhone" :loading="searching"> 搜索 </el-button>
          </el-form-item>
        </el-form>
        ...
        <div v-if="searchResult" class="search-result">
          ...
          <el-button v-else disabled style="width: 100%"> 已是好友 </el-button>
        </div>
      </el-tab-pane>
      ...
      <el-tab-pane label="乡村号搜索" name="qrcode">
        <el-form :model="qrcodeForm" label-width="80px">
          <el-form-item label="乡村号">
            <el-input v-model="qrcodeForm.qrcode" placeholder="请输入乡村号" clearable />
          </el-form-item>
          <el-form-item>
