  ...
  <div id="app">
    ...
    <div class="service-status" v-if="showStatusBar">
      <div class="status-item">
        <span
          class="status-badge"
          :class="{ 'status-success': mainApiConnected, 'status-offline': !mainApiConnected }"
        >
      ...
      <div class="status-item">
        <span
          class="status-badge"
          :class="{ 'status-success': villageApiConnected, 'status-offline': !villageApiConnected }"
        >
      ...
      <div class="status-item">
        <span
          class="status-badge"
          :class="{ 'status-success': socketConnected, 'status-pending': !socketConnected }"
        >
    ...
    <div class="floating-actions" v-if="!showStatusBar">
      <button class="fab-button" @click="showStatusBar = true" title="查看服务状态">📊</button>
    </div>
  </div>
</template>
...
const checkAllServices = async () => {
  await Promise.all([checkMainApiStatus(), checkVillageApiStatus()]);
  checkSocketStatus();
};
